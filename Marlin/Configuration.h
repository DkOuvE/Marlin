...
#define CUSTOM_MACHINE_NAME "HexaDecibel"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "54031d66-2b7d-45a3-b328-922f55ae4f10"
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_DIAGONAL_ROD 266.75        // (mm)
  ...
  #define DELTA_ENDSTOP_ADJ { -0.87, -1.83, 0.0 } // Get these values from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.29, -0.43, 0.14 } // Get these values from G33 auto calibrate
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 450, 450, 450, 27}
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION       { 7000, 7000, 7000, 1000 }
...
#define Z_CLEARANCE_BETWEEN_PROBES 18 // Z Clearance between probe points
...
#define DELAY_BEFORE_PROBING 60  // (ms) To prevent vibrations from triggering piezo sensors
...
#define PREHEAT_2_TEMP_HOTEND  224
